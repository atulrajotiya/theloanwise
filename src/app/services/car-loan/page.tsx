  ...
  return (
   <>
    <section className='container mx-auto flex flex-col gap-2 justify-center items-center py-12'>
        <h2 className='text-6xl text-financeBlue font-bold'><span className='text-gray-800'>Car</span> Loan</h2>
        ...
        <div className="grid grid-cols-3 gap-2 mt-8 text-center">
                ...
                <section className='py-12 mt-12 bg-gray-100'>
                    ...
                    <div className='flex flex-col gap-2 justify-center items-center'>
                         <h2 className='text-3xl text-financeBlue font-bold'>Why Choose Our Car Loans?</h2>
                        <p className='text-base text-gray-500 w-1/2 text-center'>
                            Drive your dream car with ease and convenience.
                        </p>
                    </div>
                    ...
                    <div className='grid grid-cols-3 gap-12 mt-12'>
                        <div className='rounded-md shadow-md py-6 px-3 bg-white text-center'>
                            ...
                            <p className='text-gray-500'>
                                Repay at your pace with customized EMI options.
                            </p>
                        </div>
                        ...
                        <div className='rounded-md shadow-md py-6 px-3 bg-white text-center'>
                            ...
                            <h2 className='text-2xl font-bold text-financeBlue mb-4'>Quick Processing</h2>
                            <p className='text-gray-500'>
                                Get instant approvals and faster disbursals.
                            </p>
                        </div>
                        ...
                        <div className='rounded-md shadow-md py-6 px-3 bg-white text-center'>
                            ...
                            <p className='text-gray-500'>
                                Hassle-free loan with simple paperwork.
                            </p>
                        </div>
                        ...
                        <div className='rounded-md shadow-md py-6 px-3 bg-white text-center'>
                            ...
                            <p className='text-gray-500'>
                                Enjoy affordable EMIs with low interest rates.
                            </p>
                        </div>
                        ...
                        <div className='rounded-md shadow-md py-6 px-3 bg-white text-center'>
                            ...
                            <p className='text-gray-500'>
                                No security required, just your trust and eligibility.
                            </p>
                        </div>
                    </div>
                    </div>
